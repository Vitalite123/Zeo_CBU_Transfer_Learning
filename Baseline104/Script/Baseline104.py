"""
Code1 Prediction Model - Predict zeolite framework structure using 104 features
...
# Set up font support for English (removed Chinese font settings)
...
class Code1Predictor:
    ...
    def load_data(self, train_path, val_path, test_path):
        ...
        if len(available_features) < len(self.feature_names):
            ...
            print("✓ All 104 features are available!")
    ...
    def save_results_table(self, results, save_path='results_table.csv'):
        ...
        try:
            ...
            print(f"Results table saved to: {temp_path} (original file is occupied)")
        return df

    def save_models(self, save_path='baseline104.pkl'):
...
def main():
    ...
    train_data, val_data, test_data = predictor.load_data(
        '../data_processed/ZEOSYN_104_struct_train.xlsx',
        '../data_processed/ZEOSYN_104_struct_val.xlsx',
        '../data_processed/ZEOSYN_104_struct_test.xlsx'
    )
    ...
    # Save models
    predictor.save_models('baseline104.pkl')

    print("\n" + "=" * 60)
    print("All tasks completed!")
    print("=" * 60)
    print("\nGenerated files:")
    print("  1. baseline104.pkl - Trained models")
